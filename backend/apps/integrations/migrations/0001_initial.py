# Generated by Django 5.0.2 on 2026-03-04 23:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('processed', 'Processed'), ('processed_with_errors', 'Processed With Errors'), ('failed', 'Failed')], default='processed', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='integrations.bulkuploadbatch')),
            ],
            options={
