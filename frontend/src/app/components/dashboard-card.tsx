...
function CardIcon({ type, color }: { type: IconType; color: IconColor }) {
  const bgClass = color === 'blue' ? styles.iconBgBlue : styles.iconBgYellow;
  const strokeClass = color === 'blue' ? styles.iconStrokeBlue : styles.iconStrokeYellow;

  const icons: Record<IconType, React.ReactElement> = {
    teachers: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={strokeClass}>
        <path d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    ranking: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={strokeClass}>
        <path d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    alerts: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={strokeClass}>
    ...
    upload: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className={strokeClass}>
        <path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
  };
