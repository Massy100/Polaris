...
const menuItems = [
  ...
  },
  {
    ...
    route: '/escalafon',
    icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>,
  },
  {
    label: 'Carga Masiva',
    route: '/bulk-upload',
      ...
      <div className={`sidebar ${isOpen ? 'open' : ''}`}>
        <div className="sidebar-top">
          <div className="sidebar-header-icons">
            <button className="sidebar-icon-btn" onClick={onClose}>
          ...
          <div className="sidebar-acceso-wrapper">
            <span className="sidebar-acceso">Acceso Rápido</span>
          </div>

          <div className="sidebar-links">
            {menuItems.map((item) => (
              <button key={item.label} className="sidebar-link" onClick={() => handleNavigate(item.route)}>
                {item.icon}
                {item.label}
              </button>
            ))}
