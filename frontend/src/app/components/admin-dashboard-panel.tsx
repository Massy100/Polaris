      ...
      >
        <div className="adp-header">
          <div className="adp-brand-info">
            <div className="adp-brand-logo">
              <img src="/icon-dash.jpg" alt="Logo URL" className="adp-logo-img" />
            </div>
            <div className={`adp-brand-text-container ${isExpanded ? 'adp-text--visible' : ''}`}>
        ...
        <div className="adp-actions-bottom">
          <div className="adp-user-profile">
            ...
            <div className={`adp-user-details ${isExpanded ? 'adp-text--visible' : ''}`}>
