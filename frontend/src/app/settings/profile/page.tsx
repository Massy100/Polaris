            ...
            <div className="profile-sidebar-hero">
              <div className="profile-avatar-wrap">
                <div className="profile-avatar">
                  {getInitials(`${personalForm.firstName} ${personalForm.lastName}`)}
                </div>
              ...
              <p className="profile-sidebar-name">{personalForm.firstName} {personalForm.lastName}</p>
              <p className="profile-sidebar-role">{personalForm.role} · {personalForm.department}</p>
            </div>
          ...
          <div className="profile-main">
            {activeSection === 'personal' && (
              <div className="profile-panel">
                <div className="profile-panel-header">
                  ...
                  <span className="url-badge url-badge-navy">Administrador</span>
                </div>
                ...
                <div className="profile-panel-body">
                  <div className="profile-form-grid">
                    ...
                    <div className="profile-field full-width">
                      ...
                      />
                      <span className="profile-field-hint">Se usará para notificaciones y recuperación de cuenta.</span>
                    </div>
                    <div className="profile-field">
                    ...
                    <div className="profile-field full-width">
                      ...
                      <input
                        ...
                        disabled
                      />
                      <span className="profile-field-hint">El rol es asignado por el superadministrador. Contáctalo para solicitar cambios.</span>
                    </div>
                  </div>
                </div>

                <div className="profile-panel-footer">
                  <button className="url-btn url-btn-ghost url-btn-sm" onClick={() =>
                    setPersonalForm({ firstName: 'Admin', lastName: 'Institucional', email: 'admin@polaris.edu.gt', phone: '', role: 'Administrador', department: 'Dirección Académica' })
                  }>
                    Descartar
                  </button>
                  <button className="url-btn url-btn-primary url-btn-sm" onClick={handleSavePersonal}>
                    Guardar cambios
                  </button>
                </div>
              </div>
              ...
              <>
                ...
                <div className="profile-danger-zone">
                  <div className="profile-danger-info">
                    ...
                    <p>Estas acciones son irreversibles. Solicita confirmación de tu equipo antes de proceder.</p>
                  </div>
                  <button className="url-btn url-btn-danger url-btn-sm">
                    Eliminar cuenta
                  </button>
                </div>
              </>
            ...
            {activeSection === 'preferences' && (
              <div className="profile-panel">
                ...
                <div className="profile-panel-body">
                  {[
                    { key: 'emailNotifications', label: 'Notificaciones por correo', desc: 'Recibe alertas de actividad relevante en tu bandeja de entrada.' },
                    { key: 'systemAlerts', label: 'Alertas del sistema', desc: 'Alertas dentro de Polaris sobre cambios en rankings y evaluaciones.' },
                    { key: 'weeklyReport', label: 'Reporte semanal', desc: 'Resumen automático cada lunes con las métricas del ciclo activo.' },
                    { key: 'twoFactor', label: 'Autenticación de dos factores', desc: 'Añade una capa extra de seguridad al iniciar sesión.' },
                  ].map(({ key, label, desc }) => (
                ...
                <div className="profile-panel-footer">
                  <button className="url-btn url-btn-primary url-btn-sm" onClick={handleSavePrefs}>
