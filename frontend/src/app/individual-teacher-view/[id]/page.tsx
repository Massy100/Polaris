...
export default function IndividualTeacherView() {
        ...
        return (
            <div className="itv-layout">
                <div className="itv-empty-state">
                    ...
                    <p>Cargando expediente del docente...</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="itv-layout flex-1">
            <button className="itv-back-btn" onClick={() => router.back()}>
                <IconBack />
                Volver al listado
            </button>
