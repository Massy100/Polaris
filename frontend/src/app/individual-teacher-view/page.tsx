...
export default function IndividualTeacherView() {
    ...
    return (
        <div className="individual-teacher-general-container bg-gray-50 min-h-screen">
